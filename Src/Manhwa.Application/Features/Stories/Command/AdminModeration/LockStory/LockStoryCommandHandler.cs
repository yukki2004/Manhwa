...
{
    public class LockStoryCommandHandler : IRequestHandler<LockStoryCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IStoryRepository _storyRepository;
        private readonly IUserRepository _userRepository;
        private readonly IPublishEndpoint _publishEndpoint;
        public LockStoryCommandHandler(IUnitOfWork unitOfWork, IStoryRepository storyRepository, IUserRepository userRepository, IPublishEndpoint publishEndpoint)
        {
        ...
        public async Task<bool> Handle(LockStoryCommand command, CancellationToken ct)
        {
            ...
            var lockCheck = story.AdminLockStatus == Domain.Enums.AdminLockStatus.Normal;
