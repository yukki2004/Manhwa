...
namespace Manhwa.Application.Features.Stories.Command.ChangePublishState.PublishStory
{
    public class PublishStoryCommandHandler : IRequestHandler<PublishStoryCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IStoryRepository _storyRepository;
        private readonly IUserRepository _userRepository;
        public PublishStoryCommandHandler(IUnitOfWork unitOfWork, IStoryRepository storyRepository, IUserRepository userRepository)
        {
            _unitOfWork = unitOfWork;
            _storyRepository = storyRepository;
            _userRepository = userRepository;
        }
        public async Task<bool> Handle(PublishStoryCommand command, CancellationToken ct)
        {
            ...
            {
                if (story.IsPublish == Domain.Enums.Story.StoryPublishStatus.Published)
                {
                    return true;
                }
                story.IsPublish = Domain.Enums.Story.StoryPublishStatus.Published;
