...
namespace Manhwa.Application.Features.Stories.Command.UpdateStoryStatus.CompleteStory
{
    public class CompleteStoryCommandHandler : IRequestHandler<CompleteStoryCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IStoryRepository _storyRepository;
        private readonly IUserRepository _userRepository;
        public CompleteStoryCommandHandler(IUnitOfWork unitOfWork, IStoryRepository storyRepository, IUserRepository userRepository)
        {
            _unitOfWork = unitOfWork;
            _storyRepository = storyRepository;
            _userRepository = userRepository;
        }
        public async Task<bool> Handle(CompleteStoryCommand command, CancellationToken ct)
        {
