...
{
    public class DropStoryCommandHandler : IRequestHandler<DropStoryCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IStoryRepository _storyRepository;
        private readonly IUserRepository _userRepository;
        public DropStoryCommandHandler(IUnitOfWork unitOfWork, IStoryRepository storyRepository, IUserRepository userRepository)
        {
            _unitOfWork = unitOfWork;
            _storyRepository = storyRepository;
            _userRepository = userRepository;
        }
        public async Task<bool> Handle(DropStoryCommand command, CancellationToken ct)
        {
            ...
            {
                if (story.Status == StoryStatus.Dropped)
                {
                    return true;
                }
                story.Status = StoryStatus.Dropped;
            }
            else
            {
