...
{
    public class OngoingStoryCommandHandler : IRequestHandler<OngoingStoryCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly IStoryRepository _storyRepository;
        private readonly IUserRepository _userRepository;
        public OngoingStoryCommandHandler(IUnitOfWork unitOfWork, IStoryRepository storyRepository, IUserRepository userRepository)
        {
            _unitOfWork = unitOfWork;
            _storyRepository = storyRepository;
            _userRepository = userRepository;
        }
        public async Task<bool> Handle(OngoingStoryCommand command, CancellationToken ct)
        {
            ...
            {
                if (story.Status == StoryStatus.Ongoing)
                {
                    return true;
                }
